  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "glass-card text-foreground hover:scale-105 hover:shadow-2xl font-semibold",
        cta: "bg-gradient-to-r from-primary to-secondary text-white hover:from-primary/90 hover:to-secondary/90 hover:scale-105 shadow-lg hover:shadow-2xl font-semibold",
        glass: "glass-card text-foreground backdrop-blur-xl border-white/30 hover:border-white/50 hover:scale-105",
      },
      size: {
